...
/**
 * A utility class for constructing HttpRequest objects with specified properties.
 */
    ...
    public static HttpRequest build(String url) {
        try {
            return HttpRequest.newBuilder()
                ...
                .GET()
                .build();
        } catch (Exception e) { // Not to future self: See if this can be passed to global exception handler
